...
//Go to Syntex projects.com
        driver.get("http://practice.syntaxtechs.net/dynamic-elements-loading.php");

        //we need to find element"button " so we can click on it.
        //click on the START button


        //as the element that contains text become visible after some time, so first we need to implement the Explicit
        // wait and get the text.
